...
class MenuTransitionManager: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate  {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let menuViewController = !self.presenting ? screens.from as CustomMenuViewController : screens.to as CustomMenuViewController
        ...
        UIView.animateWithDuration(duration, delay: 0.0, usingSpringWithDamping: 50.7, initialSpringVelocity: 50.8, options: nil, animations: {
    ...
    func offStageMenuController(menuViewController: CustomMenuViewController){
        ...
        menuViewController.aboutUsBtn.transform = self.offStage(-topRowOffset)
        //menuViewController.textPostLabel.transform = self.offStage(-topRowOffset)
        
        menuViewController.contactUs.transform = self.offStage(-middleRowOffset)
       // menuViewController.quotePostLabel.transform = self.offStage(-middleRowOffset)
        
        menuViewController.website.transform = self.offStage(-bottomRowOffset)
       // menuViewController.chatPostLabel.transform = self.offStage(-bottomRowOffset)
        
        menuViewController.productBtn.transform = self.offStage(topRowOffset)
       // menuViewController.photoPostLabel.transform = self.offStage(topRowOffset)
        
        menuViewController.findUs.transform = self.offStage(middleRowOffset)
    ...
    func onStageMenuController(menuViewController: CustomMenuViewController){
        
        // prepare menu to fade in
        menuViewController.view.alpha = 0
        
        menuViewController.aboutUsBtn.transform = CGAffineTransformIdentity
        //menuViewController.textPostLabel.transform = CGAffineTransformIdentity
        
        menuViewController.contactUs.transform = CGAffineTransformIdentity
      //  menuViewController.quotePostLabel.transform = CGAffineTransformIdentity
        
        menuViewController.website.transform = CGAffineTransformIdentity
       // menuViewController.chatPostLabel.transform = CGAffineTransformIdentity
        
        menuViewController.productBtn.transform = CGAffineTransformIdentity
        //menuViewController.photoPostLabel.transform = CGAffineTransformIdentity
        
        menuViewController.findUs.transform = CGAffineTransformIdentity
